...
STYLE_PROMPTS: dict[str, str] = {
    "average-girl": (
        ...
        "light from the side, sitting on the edge of the bed. She is "
        "looking DOWN at this exact small 30 ml perfume bottle resting "
        "on her open right palm — the bottle is held in ONE hand only, "
        "fingers gently curl around its base, and the bottle is small "
        "enough that it fits comfortably inside her cupped palm with "
        "room to spare. The bottle occupies about 15-20% of the frame, "
        "NOT more — her face and shoulders dominate the frame. Slight "
        "genuine smile as she looks at the bottle. UGC selfie aesthetic "
        "from a slightly low angle, shallow depth of field, vertical "
        "portrait composition. Keep the perfume bottle and its label "
